...
void ErnieForInferenceInferMeta(
    const MetaTensor& src_ids,
    ...
    const std::vector<const MetaTensor*>& qkv_weight,
    const std::vector<const MetaTensor*>& qkv_bias,
    const std::vector<const MetaTensor*>& out_linear_weight,
    ...
    const std::vector<const MetaTensor*>& attn_ln_scale,
    const std::vector<const MetaTensor*>& attn_ln_bias,
    const std::vector<const MetaTensor*>& ffn_ln_scale,
    const std::vector<const MetaTensor*>& ffn_ln_bias,
    const MetaTensor& post_encoder_ln_scale,
    const MetaTensor& post_encoder_ln_bias,
    const MetaTensor& mask_lm_trans_ln_scale,
    const MetaTensor& mask_lm_trans_ln_bias,
    const MetaTensor& mask_lm_trans_fc_weight,
    const MetaTensor& mask_lm_trans_fc_bias,
    const MetaTensor& mask_lm_out_fc_weight,
    const MetaTensor& mask_lm_out_fc_bias,
