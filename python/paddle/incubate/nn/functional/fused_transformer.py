...
def fused_multi_transformer_int8(x,
                            ln_scales,
                            ln_biases,
                            qkv_weights,
                            qkv_biases,
    ...
    if _non_static_mode():
        cache_kv_out, final_out = _C_ops.fused_multi_transformer_int8(
            ...
            time_step, attn_mask, linear_weights, linear_biases, ffn_ln_scales,
            ffn_ln_biases, ffn1_weights, ffn1_biases, ffn2_weights, ffn2_biases,
            qkv_out_scales, out_linear_out_scales, ffn1_out_scales,ffn2_out_scales, cache_kvs,
            'num_head',num_head, 'dim_head',dim_head, 'dim_ffn',dim_ffn,'qkv_in_scale',qkv_in_scale,
            'out_linear_in_scale', out_linear_in_scale, 'ffn1_in_scale',ffn1_in_scale,'ffn2_in_scale',ffn2_in_scale,
